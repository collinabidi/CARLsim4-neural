...
% init NetworkMonitor
NM = NetworkMonitor('../results/sim_truenorth core simulation.dat');
NM.setPlottingAttributes('BINWINDOWMS', 100);
NM.setPlottingAttributes('FPS', 8);
...
%CM = ConnectionMonitor('input','hidden','../results/');
